...
from .model import CompletedEvent, ResumeToken, StartedEvent, AmadeusEvent
...
def _log_runner_event(evt: AmadeusEvent) -> None:
...
class ProgressEdits:
    ...
    async def on_event(self, evt: AmadeusEvent) -> None:
