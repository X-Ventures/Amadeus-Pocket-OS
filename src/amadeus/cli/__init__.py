...
from .multiuser import main as multiuser_main
from .config import (
    _CONFIG_PATH_OPTION,
...
def init(
    ...
    """Register the current repo as a Amadeus project."""
    run_init(
        alias=alias,
        default=default,
...
def create_app() -> typer.Typer:
    app = typer.Typer(
        ...
        help="Telegram bridge for coding agents. Docs: https://amadeus.dev/",
    )
    config_app = typer.Typer(help="Read and modify amadeus config.")
    ...
    app.command(name="multiuser", help="Run in multi-user mode (BYOK)")(multiuser_main)
